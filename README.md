...
https://www.notion.so/36fb960cdf2e4361aac50e32d8cc3293

### 주제 선정 배경, 기획 배경

약 3개월이 넘는 시간동안 Java 등의 언어를 이용한 프로그래밍을 배우고 웹 관련 프로젝트를 진행했었습니다. 이후에 데이터 분석 파트를 시작하며 Python을 처음 배우게 되었습니다. 데이터 분석은 대부분의 학생들에게 낯선 존재였습니다. 하지만 복잡하게 보이기만 하던 데이터를 정제하고 시각화하는 과정에서 흥미를 느꼈고, 데이터 분석을 시작하는 다른 학생들에게도 이를 공유하고 싶다는 생각에서 주제를 선정했습니다. 
...
설치 방법을 간단하게 다음과 같이 정리할 수 있습니다(Windows 사용자 기준).
